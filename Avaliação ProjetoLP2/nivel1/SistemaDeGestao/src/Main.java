...
public class Main {
    ...
    private static void menuAdmin() {
        ...
        do {
            ...
            System.out.println("6. Atualizar espaço");
            System.out.println("7. Excluir espaço");
            System.out.println("8. Exportar reservas para CSV");
            System.out.println("9. Relatórios estatísticos");
    ...
    private static void fazerReserva(Usuario usuario) {
        ...
        if (conflito) {
            System.out.println("Já existe uma reserva para este espaço nesse horário. Tente outro horário.");
        } else {
            // O ID é 0 porque o banco de dados gera o ID real automaticamente
            ...
            // ComprovanteDAO.gerar(nova); // Esta linha pode causar um comprovante com ID 0
